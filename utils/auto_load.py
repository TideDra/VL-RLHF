...
class MyAutoModel:
    ...
    def from_pretrained(model_name_or_path, *model_args, **kwargs) -> PreTrainedModel:
        ...
        return AUTOMODEL_MAP[architecture].from_pretrained(model_name_or_path, trust_remote_code=True,*model_args, **kwargs)
...
class MyAutoProcessor:
    ...
    def from_pretrained(model_name_or_path, **kwargs) -> VLProcessor:
        config = AutoConfig.from_pretrained(model_name_or_path,trust_remote_code=True)
        architecture = config.architectures[0]
        return AUTOPROCESSOR_MAP[architecture](model_name_or_path,trust_remote_code=True, **kwargs)
